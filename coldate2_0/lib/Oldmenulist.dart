...
/* //過去データ配列に検索値を選択
                                      listitem.forEach((element) { 
                                        print("DB date" + element["date"]);
                                        print("select date" + _date.year.toString() + "-" + _date.month.toString() + "-" + _date.day.toString());
                                        var splitmenu = element["menuname"].split("【");
                                        if(element["date"].toString() == _date.year.toString() + "-" + _date.month.toString() + "-" + _date.day.toString()){
                                          print("合致");
                                          pastlistitem.add({
                                            "date": element["date"],
                                            "datetime": element["datetime"],
